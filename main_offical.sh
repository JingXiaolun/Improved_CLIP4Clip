...
#--data_path ${FILE_DATA_PATH} \
#--features_path ${VIDEO_DATA_PATH} \
#--output_dir ../Model/Offical/lsmdc_retrieval_looseType_meanP \
#--log_dir ../Log/Offical/lsmdc_retrieval_looseType_meanP \
#--visualize_dir ../Visualize/Log/Offical/lsmdc_retrieval_looseType_meanP \
#--lr 1e-4 --max_words 32 --max_frames 12 --batch_size_val 16 \
#--datatype lsmdc \
#--feature_framerate 1 --coef_lr 1e-3 \
#--freeze_layer_num 0  --slice_framepos 2 \
...
#--data_path ${FILE_DATA_PATH} \
#--features_path ${VIDEO_DATA_PATH} \
#--output_dir ../Model/Offical/lsmdc_retrieval_looseType_seqLSTM \
#--log_dir ../Log/Offical/lsmdc_retrieval_looseType_seqLSTM \
#--visualize_dir ../Visualize/Log/Offical/lsmdc_retrieval_looseType_seqLSTM \
#--lr 1e-4 --max_words 32 --max_frames 12 --batch_size_val 16 \
#--datatype lsmdc \
#--feature_framerate 1 --coef_lr 1e-3 \
#--freeze_layer_num 0  --slice_framepos 2 \
...
#--data_path ${FILE_DATA_PATH} \
#--features_path ${VIDEO_DATA_PATH} \
#--output_dir ../Model/Offical/lsmdc_retrieval_looseType_seqTransf \
#--log_dir ../Log/Offical/lsmdc_retrieval_looseType_seqTransf \
#--visualize_dir ../Visualize/Log/Offical/lsmdc_retrieval_looseType_seqTransf \
#--lr 1e-4 --max_words 32 --max_frames 12 --batch_size_val 16 \
#--datatype lsmdc \
#--feature_framerate 1 --coef_lr 1e-3 \
#--freeze_layer_num 0  --slice_framepos 2 \
...
#--data_path ${FILE_DATA_PATH} \
#--features_path ${VIDEO_DATA_PATH} \
#--output_dir ../Model/Offical/lsmdc_retrieval_tightTransf \
#--log_dir ../Log/Offical/lsmdc_retrieval_tightTransf \
#--visualize_dir ../Visualize/Log/Offical/lsmdc_retrieval_tightTransf \
#--lr 1e-4 --max_words 32 --max_frames 12 --batch_size_val 16 \
#--datatype lsmdc \
#--feature_framerate 1 --coef_lr 1e-3 \
#--freeze_layer_num 0  --slice_framepos 2 \
