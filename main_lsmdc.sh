...
## use token removal + keep rate + meanP video output
#FILE_DATA_PATH='../DataSet/LSMDC/data/compressed/split_file'
#VIDEO_DATA_PATH='../DataSet/LSMDC/data/compressed/video_frame_input'
...
#--data_path ${FILE_DATA_PATH} \
#--features_path ${VIDEO_DATA_PATH} \
#--output_dir ../Model/Fusion_Removal/Removal_Improved/keep_rate_0.6/meanP_video_output/lsmdc_retrieval_looseType_seqTransf \
#--log_dir ../Log/Fusion_Removal/Removal_Improved/keep_rate_0.6/meanP_video_output/lsmdc_retrieval_looseType_seqTransf \
#--visualize_dir ../Visualize/Log/Fusion_Removal/Removal_Improved/keep_rate_0.6/meanP_video_output/lsmdc_retrieval_looseType_seqTransf \
#--lr 1e-4 --max_words 32 --max_frames 12 --batch_size_val 16 \
#--datatype lsmdc \
#--feature_framerate 1 --coef_lr 1e-3 \
#--freeze_layer_num 0  --slice_framepos 2 \
